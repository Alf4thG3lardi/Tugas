    ...
    $.ajax({
        ...
        success: function (response) {
            $.each(response.products, function (key, val) { 
                ...
                <td>
                    <button class="btn btn-primary" id="cart" value="${val.id}">CART</button>
                </td>
                </tr>`;
            });
            $("#tbody").html(out);
...
function cartData(id) {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (response) {
            out += `<table class='table table-striped-columns'>
            <thead>
            <tr>
                <th>ID</th>
                <th>Item</th>
...
function getDataCustom() {
    $.ajax({
        type: "get",
        url: "http://localhost/php/select.php",
        dataType: "json",
        success: function (response) {
            let out = "";
            $.each(response, function (key, val) { 
                out += `<tr>
                    ...
                    <td>
                        <button class="btn btn-primary" id="order-cus" value="${val.id}">ORDER</button>
                    </td>
                </tr>`;
            });
            $("#tbody").html(out);
...
function orderCustom(id) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            <tr>
                <td id="data-idpelanggan">${response.id}</td>
                <td id="data-pelanggan">${response.pelanggan}</td>
                <td id="data-alamat">${response.alamat}</td>
            </tr>
            <tr>
                <td><button class="btn btn-success" id="addtocart">Add 2 Cart</button></td>
            </tr>`;
            $("#pelanggan").html(out);
...
$(document).on('click', "#order-cus", function () {
    let id = $(this).attr("value");
    orderCustom(id);
});
...
function addToCart() {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/php/addtocart.php",
        cache: false,
        data: JSON.stringify(data),
        success: function (response) {
            alert(response);
...
//                     </td>
//                     <td>
//                         <button class="btn btn-primary" id="custom-order" value="${val.idpelanggan}">Pelanggan</button>
//                     </td>
//                 </tr>`;
//             });
//             $("#tbody").html(out);
