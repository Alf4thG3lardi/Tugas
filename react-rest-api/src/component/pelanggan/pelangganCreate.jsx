...
export const PelangganCreate = () => {
    const { storePelanggan, formValues3, onChange3, errors, setErrors} = useContext(SkillContext);
    useEffect(() => {
        setErrors({})
    }, []);
    return (
    <div className="mt-12"> 
        <form onSubmit={storePelanggan} className="max-w-md mx-auto p-4 bg-white shadow-md rounded-md">
